...
void FuhrmanomegaWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& omega =
        static_cast<const volScalarField&>(this->internalField());
...
void FuhrmanomegaWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void FuhrmanomegaWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbModel,
...
scalarField& FuhrmanomegaWallFunctionFvPatchScalarField::G(bool init)
{
...
void FuhrmanomegaWallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void FuhrmanomegaWallFunctionFvPatchScalarField::manipulateMatrix
(
