...
void knoppOmegaWallFunctionFvPatchScalarField::checkType()
{
...
void knoppOmegaWallFunctionFvPatchScalarField::writeLocalEntries(Ostream& os)
const
{
...
knoppOmegaWallFunctionFvPatchScalarField
(
    const knoppOmegaWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
knoppOmegaWallFunctionFvPatchScalarField
(
    const knoppOmegaWallFunctionFvPatchScalarField& owfpsf
)
:
...
void knoppOmegaWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    forAll(nutw, facei)
    {
        ...
        // omega value on face, Knopp (2010)
        newOmegaValues[facei] = min(
            utau / (sqrtBetaStar * kappa * (d0Tilde + smallVal)),
...
void knoppOmegaWallFunctionFvPatchScalarField::write(Ostream& os) const
{
